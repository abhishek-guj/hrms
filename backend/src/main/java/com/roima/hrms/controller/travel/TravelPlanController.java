...
public class TravelPlanController {
        ...
        @PutMapping("{id}")
        public ResponseEntity<ApiResponse> updateTravelPlan(@PathVariable Long id,
        ...
        public ResponseEntity<ApiResponse> addTravelEmployees(@PathVariable Long id,
        ...
        public ResponseEntity<ApiResponse> deleteTravelEmployees(@PathVariable Long id, @PathVariable Long employeeId) {
                boolean travelEmployees = travelEmployeeService.deleteTravelEmployees(id, employeeId);
                ApiResponse<Boolean> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS,
                                "Successfully fetched Travel Employees", travelEmployees, null);
                return ResponseEntity.status(HttpStatus.OK).body(res);
        }
