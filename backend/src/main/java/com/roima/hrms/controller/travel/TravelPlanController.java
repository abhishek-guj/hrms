...
public class TravelPlanController {
    ...
    public TravelPlanController(TravelPlanService travelPlanService, TravelEmployeeService travelEmployeeService, TravelExpenseService travelExpenseService) {
    ...
    public ResponseEntity<ApiResponse> getTravelEmployees(@PathVariable Long id) {
        ...
        ApiResponse<List<TravelEmployeeDto>> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS, "Successfully fetched Travel Employees", travelEmployeeDtoList, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }
    ...
    public ResponseEntity<ApiResponse> addTravelEmployees(@PathVariable Long id, @RequestBody List<Long> employeeIds) {
        ...
        ApiResponse<Boolean> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS, "Successfully fetched Travel Employees", travelEmployees, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }

    //    @PreAuthorize("hasRole('ROLE_Admin, ROLE_Hr')")
    @DeleteMapping("{id}/employees")
    public ResponseEntity<ApiResponse> deleteTravelEmployees(@PathVariable Long id, @RequestBody List<TravelEmployeeReqDto> dto) {
        boolean travelEmployees = travelEmployeeService.deleteTravelEmployees(id, dto);
        ApiResponse<Boolean> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS, "Successfully fetched Travel Employees", travelEmployees, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }
    @PutMapping("{id}/employees")
    public ResponseEntity<ApiResponse> updateTravelEmployees(@PathVariable Long id, @RequestBody List<Long> employeeIds) {
        travelEmployeeService.updateTravelEmployees(id, employeeIds);
        ApiResponse<Boolean> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS, "Successfully added Travel Employees", true, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }
...
// ---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public ResponseEntity<ApiResponse> getAllTravelExpensesByTravelPlan(@PathVariable Long travelPlanId){
        List<TravelExpenseDto> travelExpenseDtoList = travelExpenseService.getAllTravelExpensesByTravelPlanId(travelPlanId);
