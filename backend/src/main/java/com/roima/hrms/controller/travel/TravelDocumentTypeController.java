...
public class TravelDocumentTypeController {
    ...
    public ResponseEntity<ApiResponse> getAllTravelDocumentTypes() {
        ...
        ApiResponse<List<TravelDocumentTypeDto>> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS,
                "Fetched all TravelDocument types successfully", travelDocumentTypeDtoList, null);
    ...
    public ResponseEntity<ApiResponse> createTravelDocumentType(@RequestBody TravelDocumentTypeRequestDto dto) {
        ...
        ApiResponse<TravelDocumentTypeDto> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS,
                "Successfully created TravelDocument type.", tt, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }
    ...
    public ResponseEntity<ApiResponse> getTravelDocumentType(@PathVariable Long id) {
        ...
        ApiResponse<TravelDocumentTypeDto> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS,
                "Successfully fetched TravelDocument type", tt, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }

    @PutMapping("{id}")
    public ResponseEntity<ApiResponse> updateTravelDocumentType(@PathVariable Long id,
            @RequestBody TravelDocumentTypeRequestDto dto) {
        TravelDocumentTypeDto travelDocumentType = travelDocumentTypeService.updateTravelDocumentType(id, dto);
        ApiResponse<TravelDocumentTypeDto> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS,
                "Successfully updated TravelDocument type", travelDocumentType, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }
    ...
    public ResponseEntity<ApiResponse> deleteTravelDocumentType(@PathVariable Long id) {
        ...
        ApiResponse<Void> res = ApiResponse.createApiResponse(ApiResponseType.SUCCESS,
                "Successfully deleted TravelDocument type", null, null);
        return ResponseEntity.status(HttpStatus.OK).body(res);
    }
}
