...
public class TravelSeeder implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public TravelSeeder(TravelPlanRepository travelPlanRepository, TravelTypeRepository travelTypeRepository, TravelEmployeeRepository travelEmployeeRepository, EmployeeProfileRepository employeeProfileRepository) {
...
//        if (travelPlanRepository.count() == 0) {
            ...
            TravelEmployee travelEmployee1 = new TravelEmployee();
            travelEmployee1.setTravelPlan(travelPlan1);
            travelEmployee1.setEmployeeProfile(employeeProfileRepository.findByFirstName("ad").orElseThrow());
            travelEmployeeRepository.save(travelEmployee1);
            TravelEmployee travelEmployee2 = new TravelEmployee();
            travelEmployee2.setTravelPlan(travelPlan1);
            travelEmployee2.setEmployeeProfile(employeeProfileRepository.findByFirstName("employee").orElseThrow());
            travelEmployeeRepository.save(travelEmployee2);
